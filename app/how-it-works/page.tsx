    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-16 px-4 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-brand-400 text-sm font-semibold uppercase tracking-widest mb-3">Simple & Automated</p>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-2">
            <Users size={22} className="text-brand-400" /> For Event Hosts
          </h2>
          <div className="space-y-5">
            {[
              ...
              <div key={step} className="flex gap-5 glass-card p-5">
                ...
                <div className="flex items-start gap-4">
                  <Icon size={20} className="text-brand-400 flex-shrink-0 mt-0.5" />
                  <div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8 flex items-center gap-2">
            <Sparkles size={22} className="text-brand-400" /> For Vendors
          </h2>
          <div className="space-y-5">
            {[
        ...
        <div className="glass-card p-8 mb-10">
          <h2 className="text-xl font-bold text-white text-center mb-6 flex items-center justify-center gap-2">
            <Shield size={20} className="text-brand-400" /> Why Trust Bold Party?
          </h2>
