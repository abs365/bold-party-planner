  ...
  return (
    <DashboardLayout user={profile as Profile}>
      <div className="max-w-4xl mx-auto">
        ...
        {params.success && (
          <div className="glass-card p-4 mb-6 border border-green-500/30 flex items-center gap-3 text-green-300">
        ...
        {params.cancelled && (
          <div className="glass-card p-4 mb-6 border border-yellow-500/30 flex items-center gap-3 text-yellow-300">
