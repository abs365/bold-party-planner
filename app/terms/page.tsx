...
export default function TermsOfService() {
  return (
    <LegalPage
      ...
      subtitle="The terms and conditions governing your use of the Bold Party platform."
      lastUpdated="May 2026"
      sections={[
        {
          title: "1. Agreement to Terms",
          content: "By accessing or using Bold Party Event Planner ('the Platform'), you agree to be bound by these Terms of Service. If you do not agree, you must not use the Platform. These terms apply to all users including customers, vendors, and visitors.",
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            "You are responsible for maintaining the security of your account credentials. Notify us immediately at support@boldparty.co.uk if you suspect unauthorised access.",
        ...
        },
        {
          ...
          content: [
            "When you request a booking, you enter into a direct contract with the vendor for the services described. Bold Party facilitates this transaction but is not party to the service contract.",
        ...
        },
        {
          ...
          content: [
            ...
            "Vendors are independent businesses and not employees, agents, or partners of Bold Party.",
            "Bold Party charges a 10% platform commission on completed bookings. Payouts are made within 7 business days of event completion.",
        ...
        },
        {
          ...
          content: [
            ...
            "Bold Party charges a service fee to vendors (10% commission). This is included in the prices shown to customers.",
          ],
        },
        {
          ...
          content: [
            ...
            "Attempting to contact or transact with vendors outside the Bold Party platform (to avoid fees) is a breach of these terms and may result in account termination.",
          ],
        },
        {
          title: "8. Intellectual Property",
          content: [
            "Bold Party and its content (excluding user-generated content) are protected by UK copyright and intellectual property law.",
            "By uploading content (photos, videos, descriptions) to the Platform, you grant Bold Party a non-exclusive, worldwide, royalty-free licence to use, display, and reproduce that content for the purpose of operating and promoting the Platform.",
        ...
        },
        {
          ...
          content: [
            ...
            "Bold Party is not liable for the quality, safety, or legality of vendor services. We facilitate connections but do not provide the underlying services.",
            "To the maximum extent permitted by UK law, our total liability to you for any claim arising from use of the Platform shall not exceed the total fees paid by you to Bold Party in the preceding 12 months.",
        ...
        },
        {
          ...
          content: [
            "In the event of a dispute between a customer and vendor, we offer a dispute resolution service. Contact disputes@boldparty.co.uk within 48 hours of the issue arising.",
            "Bold Party's decision in dispute matters is made in good faith but is not binding arbitration. Parties retain their legal rights.",
          ],
        },
        {
