...
export default function VendorTerms() {
  return (
    <LegalPage
      ...
      subtitle="Additional terms and obligations for event professionals listing services on Bold Party."
      lastUpdated="May 2026"
      sections={[
        {
          title: "1. Vendor Status",
          content: [
            "By applying as a vendor on Bold Party, you agree to these Vendor Terms in addition to our general Terms of Service.",
            ...
            "You are an independent business, not an employee, agent, or contractor of Bold Party.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            "Bold Party charges a 10% commission on the total booking value. This is deducted from your payout before funds are transferred.",
        ...
        },
        {
          ...
          content: [
            "You must behave professionally at all times when representing services booked through Bold Party.",
            ...
            "You must not engage in any activity that could bring Bold Party's reputation into disrepute.",
          ],
        },
        {
          ...
          content: [
            ...
            "By uploading content, you grant Bold Party a non-exclusive licence to display that content on the platform and in marketing materials.",
        ...
        },
        {
          ...
          content: [
            ...
            "Suspended vendors will be notified by email. You may appeal a suspension by contacting vendor-support@boldparty.co.uk.",
          ],
        },
        {
