...
export function VendorApplyForm({ profile }: VendorApplyFormProps) {
                      ...
                      {formData.category === "other" && (
                        <div className="mt-4">
                          ...
                          <p className="text-xs text-gray-400 mb-2">
                            Tell us exactly what you offer.
                          </p>
                          <textarea
                ...
                {step === 2 && (
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mb-2 font-light">Used to match you with relevant customer budgets. Not shown publicly.</p>
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Example: Award-winning DJ with 8 years of experience across weddings, birthday parties and corporate events."
                        rows={5}
