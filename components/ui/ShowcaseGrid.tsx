...
import { Play, BadgeCheck, Star, MapPin, ArrowRight, SlidersHorizontal } from "lucide-react";
...
export function ShowcaseGrid({ items }: ShowcaseGridProps) {
  ...
  // Determine which filter tabs have content
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-24">
            ...
            <p className="text-gray-400 text-sm">
              Vendors in this category will showcase their work here soon.
            </p>
      ...
      <div className="p-3">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-sm font-semibold text-gray-900 truncate group-hover:text-[#0B1F4D] transition-colors">
        ...
        {item.caption && (
          <p className="text-xs text-gray-500 mt-1.5 line-clamp-2 font-light">{item.caption}</p>
        )}
      </div>
    </Link>
  );
