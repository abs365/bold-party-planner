...
import {
  ...
  Mail, Phone, MapPin, Tag, Copy, Check,
  Send, RefreshCw, X, BarChart3, Target, Clock,
  TrendingUp, CheckCircle2, Edit3, Trash2, MessageSquare,
  Share2, Download,
} from "lucide-react";
...
export function AcquisitionCRMView() {
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute top-2 right-2">
                          <LeadCopyButton text={outreach[activeOutreachTab]} />
                        </div>
                      </div>
